...
const InputWithMask: React.VFC<IInput> = (props): JSX.Element => {
  const {
    mask = "",
    element = "input",
    type = "text",
  ...
  const showButtonIcon = Boolean(icon);
  const showClearIcon = Boolean(content) && !showButtonIcon && isFocused;
  const showValidIcon = !showButtonIcon && !showClearIcon && isValid;
  const showErrorIcon = !showButtonIcon && !showClearIcon && isError;
